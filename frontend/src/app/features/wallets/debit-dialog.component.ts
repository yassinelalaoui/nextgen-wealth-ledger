...
@Component({
  ...
  template: `
    <h2 mat-dialog-title>Debit Account</h2>
    <mat-dialog-content>
    ...
    <mat-dialog-actions align="end">
      ...
      <button mat-flat-button color="warn" [disabled]="form.invalid" (click)="submit()">Debit</button>
    </mat-dialog-actions>
  `
})
export class DebitDialogComponent {
  form: FormGroup;

  constructor(
    fb: FormBuilder,
    public dialogRef: MatDialogRef<DebitDialogComponent>,
